...
export function HelpChatbot() {
  ...
  if (isMinimized) {
    return (
      <button
        ...
        className="fixed bottom-20 right-4 z-50 px-4 py-3 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center gap-2 hover:scale-105 transition-transform"
  ...
  return (
    <Card 
      className="fixed bottom-20 right-4 z-50 w-[calc(100vw-2rem)] max-w-[380px] h-[500px] max-h-[70vh] flex flex-col shadow-2xl border-primary/20"
