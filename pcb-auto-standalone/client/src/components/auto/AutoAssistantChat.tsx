...
const NAV_TARGETS: Record<string, { label: string; route: string; highlightId?: string; toast?: string }> = {
  "revenue": { label: "Revenue", route: "/dashboard", highlightId: "stat-revenue", toast: "Revenue (Month)" },
  "open-ros": { label: "Open ROs", route: "/dashboard", highlightId: "stat-open-ros", toast: "Open Repair Orders" },
  "total-customers": { label: "Total Customers", route: "/dashboard", highlightId: "stat-total-customers", toast: "Total Customers" },
  "appointments": { label: "Today's Appointments", route: "/dashboard", highlightId: "stat-appointments", toast: "Today's Appointments" },
  "fees-saved": { label: "Fees Saved", route: "/dashboard", highlightId: "card-dual-pricing-widget", toast: "Dual Pricing Savings" },
  "work-orders": { label: "Work Orders", route: "/repair-orders", toast: "Work Orders" },
  "estimates": { label: "Estimates", route: "/repair-orders", toast: "Estimates" },
  "customers": { label: "Customers", route: "/customers", toast: "Customer Management" },
  "vehicles": { label: "Vehicles", route: "/customers", toast: "Vehicle Records" },
  "schedule": { label: "Schedule", route: "/schedule", toast: "Today's Schedule" },
  "inspections": { label: "Inspections (DVI)", route: "/inspections", toast: "Digital Vehicle Inspections" },
  "invoices": { label: "Invoices", route: "/repair-orders", toast: "Invoices" },
  "parts": { label: "Parts", route: "/repair-orders", toast: "Parts Ordering" },
  "reports": { label: "Reports", route: "/reports", toast: "Reports & Analytics" },
  "report-cash-card": { label: "Cash vs Card Report", route: "/reports", toast: "Cash vs Card Report" },
  "report-revenue": { label: "Revenue Report", route: "/reports", toast: "Revenue Report" },
  "report-tech": { label: "Tech Productivity", route: "/reports", toast: "Tech Productivity" },
  "report-customers": { label: "Customer Report", route: "/reports", toast: "Customer Report" },
  "settings": { label: "Settings", route: "/settings", toast: "Shop Settings" },
  "settings-dual-pricing": { label: "Dual Pricing Settings", route: "/settings", toast: "Dual Pricing Configuration" },
  "settings-staff": { label: "Staff Management", route: "/staff", toast: "Staff & Roles" },
  "settings-quickbooks": { label: "QuickBooks", route: "/quickbooks", toast: "QuickBooks Integration" },
  "new-ro": { label: "New Work Order", route: "/repair-orders/new", toast: "Create New Work Order" },
  "payment-processor": { label: "Payment Processor", route: "/processor", toast: "Payment Processor Setup" },
  "esign": { label: "E-Signatures", route: "/esign", toast: "E-Signature Documents" },
  "pipeline": { label: "Pipeline", route: "/pipeline", toast: "Prospect Pipeline" },
  "quickbooks": { label: "QuickBooks", route: "/quickbooks", toast: "QuickBooks Integration" },
};

function getPageKey(): string {
  const path = window.location.pathname;
  if (path.includes("/repair-orders/") && !path.endsWith("/new")) return "ro-detail";
  ...
  if (path.includes("/processor")) return "payment-processor";
  if (path.includes("/esign")) return "esign";
