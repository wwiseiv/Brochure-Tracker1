...
const NAV_ITEMS = [
  ...
  { path: "/repair-orders", label: "Repair Orders", shortLabel: "ROs", icon: FileText },
  { path: "/customers", label: "Customers", shortLabel: "Cust", icon: Users },
  { path: "/inspections", label: "Inspections", shortLabel: "Insp", icon: ClipboardCheck },
  { path: "/schedule", label: "Schedule", shortLabel: "Sched", icon: Calendar },
  { path: "/reports", label: "Reports", shortLabel: "Reports", icon: BarChart3 },
  { path: "/reports-v2", label: "Analytics", shortLabel: "Analytics", icon: TrendingUp },
  { path: "/tech-portal", label: "Tech Portal", shortLabel: "Tech", icon: Clock },
  { path: "/quickbooks", label: "QuickBooks", shortLabel: "QB", icon: Landmark },
  { path: "/settings", label: "Settings", shortLabel: "Settings", icon: Settings },
];

const BOTTOM_TAB_ITEMS = [
  { path: "/dashboard", label: "Home", icon: LayoutDashboard, testId: "bottomnav-home" },
  { path: "/repair-orders", label: "ROs", icon: FileText, testId: "bottomnav-ros" },
  { path: "/customers", label: "Cust", icon: Users, testId: "bottomnav-cust" },
  { path: "/schedule", label: "Schedule", icon: Calendar, testId: "bottomnav-schedule" },
];

const MORE_SHEET_ITEMS = [
  { path: "/inspections", label: "Inspections", icon: ClipboardCheck },
  { path: "/reports", label: "Reports", icon: BarChart3 },
  { path: "/reports-v2", label: "Analytics", icon: TrendingUp },
  { path: "/tech-portal", label: "Tech Portal", icon: Clock },
      ...
      <header className="hidden sm:flex sticky top-0 z-50 items-center justify-between gap-2 px-4 py-2 border-b bg-background">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => { logout(); setLocation("/login"); }} data-testid="button-logout">
        ...
        <div className="px-4 pb-6 space-y-1">
          ...
          {isOwnerOrManager && (
            <Link href="/staff">
              <button
                className={`flex items-center gap-3 w-full px-3 py-3 rounded-md text-sm ${
                  location.startsWith("/staff") ? "text-primary bg-primary/10" : "text-foreground"
                }`}
                onClick={() => setMoreSheetOpen(false)}
          ...
          {isOwnerOrManager && (
            <Link href="/quickbooks">
              <button
                className={`flex items-center gap-3 w-full px-3 py-3 rounded-md text-sm ${
                  location.startsWith("/quickbooks") ? "text-primary bg-primary/10" : "text-foreground"
                }`}
                onClick={() => setMoreSheetOpen(false)}
          ...
          {isOwnerOrManager && (
            <Link href="/processor">
              <button
                className={`flex items-center gap-3 w-full px-3 py-3 rounded-md text-sm ${
                  location.startsWith("/processor") ? "text-primary bg-primary/10" : "text-foreground"
                }`}
                onClick={() => setMoreSheetOpen(false)}
