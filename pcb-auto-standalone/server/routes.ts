...
import { autoAuth, autoRequireRole, hashPassword, comparePasswords, generateToken, type AutoAuthUser } from "./auth";
import crypto from "crypto";
import { randomUUID } from "crypto";
import multer from "multer";
import { generateROPdf, generateDviPdf } from "./pdf";
import { objectStorageClient } from "./replit_integrations/object_storage/objectStorage";
import { sendAutoInvoiceEmail } from "./email";
