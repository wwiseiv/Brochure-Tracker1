...
import type { EsignMerchantRecord } from "@shared/schema";
import type { FormFieldDefinition } from "./document-library";
 ...
 */
export function mapMerchantToFormFields(
  merchant: Partial<EsignMerchantRecord>,
 ...
 */
export function createBlankMerchant(): Partial<EsignMerchantRecord> {
  return {
    status: "prospect",
    businessAddress: {
      street: "",
  ...
  } as Partial<EsignMerchantRecord>;
}

/**
 * Get full name from owner
 */
export function getFullName(owner: { firstName?: string; lastName?: string }): string {
