/**
 * ManualReviewSheet Component
 * ===========================
 * 
 * Displays when AI extraction has low confidence and needs user verification.
 * Shows what was extracted, highlights issues, and lets user correct values.
 * 
 * USAGE:
 *   1. Copy to: client/src/components/ManualReviewSheet.tsx
 *   2. Import and use in statement-analyzer.tsx when needsManualReview is true
 */
