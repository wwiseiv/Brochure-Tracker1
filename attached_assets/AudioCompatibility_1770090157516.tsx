 ...
 * 
 * INSTALLATION:
 *   Copy to: client/src/components/AudioCompatibility.tsx
 */
...
import { BrowserSupport } from '@/hooks/use-audio-recorder';
...
/**
 * Banner showing browser compatibility status
 */
export function AudioCompatibilityBanner({
  ...
  // Don't show if fully supported and showOnlyIfIssues is true
...
/**
 * Small badge showing compatibility status
 */
...
/**
 * Shows list of supported audio formats
 */
...
// ============================================
// FULL COMPATIBILITY CHECK PANEL
// ============================================
...
/**
 * Full panel showing all compatibility details
 */
export function AudioCompatibilityCheck({ support, onRetry, className = '' }: CompatibilityCheckProps) {
  const checks = [
    {
...
// ============================================
// RECORDING UNAVAILABLE FALLBACK
// ============================================
...
/**
 * Fallback UI when recording is not available
 */
