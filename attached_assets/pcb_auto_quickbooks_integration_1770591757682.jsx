...
export default function QuickBooksIntegration() {
  ...
  const tabs = [
    ...
    { id: "mapping", label: "Account Mapping", icon: "🔗" },
    { id: "log", label: "Sync Log", icon: "📋" },
    { id: "settings", label: "Connection", icon: "⚙️" },
  ];
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <div style={{ fontSize: 20, fontWeight: 700, color: "white", letterSpacing: "-0.3px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          {connected && (
            <button onClick={handleSync} disabled={syncing} style={{
              ...
              <span style={{ animation: syncing ? "spin 1s linear infinite" : "none", display: "inline-block" }}>
                {syncing ? "⟳" : "↻"}
              </span>
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
                {[
                  { step: "1", title: "RO Invoiced", desc: "When you invoice a repair order in PCB Auto, an invoice is created in QuickBooks with matching line items (labor, parts, fees).", icon: "📄" },
                  { step: "2", title: "Payment Recorded", desc: "When the customer pays (cash or card), the payment is recorded against the QBO invoice. Dual pricing splits automatically.", icon: "💳" },
                  { step: "3", title: "Accounts Updated", desc: "Revenue goes to your income accounts. Dual pricing amount goes to its own account. Tax to liability. Tips tracked separately.", icon: "📊" },
                  { step: "4", title: "Set & Forget", desc: "Everything syncs automatically in real time. No CSV exports, no manual entry, no reconciliation headaches.", icon: "✅" },
                ].map((s, i) => (
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderTop: "2px solid rgba(255,255,255,0.1)" }}>
                      ...
                      <td style={{ padding: "12px 14px", fontSize: 12, color: "#4ade80", fontWeight: 600 }}>✓ Balanced</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div>
            <div style={{
              ...
              <div style={{ display: "grid", gap: 2 }}>
                ...
                {[
                  { key: "labor", label: "Labor Revenue", desc: "Hourly labor charges on repair orders", icon: "🔧" },
                  { key: "parts", label: "Parts Revenue", desc: "Parts sold to customers (retail price)", icon: "⚙️" },
                  { key: "dualPricing", label: "Dual Pricing Income", desc: "Card price − cash price on card transactions", icon: "💰" },
                  { key: "shopSupplies", label: "Shop Supplies", desc: "Shop supply fees charged to customers", icon: "🧴" },
                  { key: "salesTax", label: "Sales Tax Collected", desc: "State and local tax collected", icon: "🏛️" },
                  { key: "tips", label: "Tips Collected", desc: "Customer tips on payments", icon: "💵" },
                  { key: "partsCogs", label: "Parts Cost (COGS)", desc: "Wholesale cost of parts sold", icon: "📦" },
                  { key: "deposit", label: "Deposit Account", desc: "Where funds are deposited", icon: "🏦" },
                  { key: "ar", label: "Accounts Receivable", desc: "Unpaid invoices pending payment", icon: "📄" },
                  { key: "undeposited", label: "Undeposited Funds", desc: "Card payments before bank deposit", icon: "⏳" },
                ].map((item, i) => {
                      ...
                      >
                        <td style={{ padding: "12px 14px" }}>
                          <span style={{
                            ...
                            {s.status === "synced" ? "✓ Synced" : s.status === "pending_payment" ? "⏳ Pending" : "⚠ Error"}
                          </span>
                        </td>
                ...
                <div>
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 12, color: "#4ade80", marginTop: 4, fontWeight: 600 }}>✓ Connected since Jan 15, 2026</div>
                    </div>
              ...
              <div style={{ display: "grid", gap: 16 }}>
                {[
                  ...
                  <div key={setting.id} style={{
                    ...
                    <button onClick={() => setting.setter(!setting.value)} style={{
